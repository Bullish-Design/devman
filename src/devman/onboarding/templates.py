"""Default onboarding templates for devman workspaces."""
...
DEFAULT_NVIM_INIT_LUA = dedent(
    """\
    -- Workspace-specific Neovim configuration for devman.
    -- Keep this file minimal and add keymaps/plugins only as needed.
    """
)


def render_workspace_toml(workspace_name: str) -> str:
    """Render the default workspace TOML with the provided workspace name."""
    return DEFAULT_WORKSPACE_TOML.format(workspace_name=workspace_name)
